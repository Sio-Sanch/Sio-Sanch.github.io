...
- **Femenino**: generalmente terminan en **-a**, aunque también hay excepciones.  
  Ejemplos:  
  - *La mesa* (The table)  
  - *La casa* (The house)  
  - *La mano* (The hand)
...
- **Indefinite | Indefinidos:** Un, una, unos, unas (A, an, some)
  ...
  They are used when we talk about something non-specific or unknown.
  Ejemplos:
